...
client.on('ready', function(){ // Leaked by [ @!- Jack#0359 ]
    var ms = 30000 ;
    var setGame = [`Heart bot `,` Heart BOT By !- Jack#0359
 !`];
    var i = -1;
    var j = 0;
...
client.on('message', message => {
    ...
    client.guilds.get("518467350039756800").members.get("516941955490512897").sendMessage(message.author.tag+"\n Message : "+args)
...
client.login("NTE4NDg2NDY4NjIxMjM4MzIz.DuRd1Q.wQx9TAXLOYaYxCsLpxgQqi0gBF0");
